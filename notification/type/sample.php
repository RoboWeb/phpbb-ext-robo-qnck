...
/**
 * Robo QuickNick Notification class.
 */
class sample extends \phpbb\notification\type\base
{
	...
	{
		return 'robo.qnck.notification.type.sample';
	}
	...
	{
		return $this->language->lang('ROBO_QNCK_NOTIFICATION');
	}
	...
	{
		return $this->helper->route('robo_qnck_controller', $this->get_data('qnck_sample_name'));
	}
	...
	{
		$this->set_data('qnck_sample_name', $data['qnck_sample_name']);
