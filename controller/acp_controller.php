...
class acp_controller
{
	...
	public function display_options()
	{
		...
		$this->language->add_lang('common', 'robo/qnck');

		// Create a form key for preventing CSRF attacks
		add_form_key('robo_qnck_acp');
		...
		if ($this->request->is_set_post('submit'))
		{
			...
			if (!check_form_key('robo_qnck_acp'))
			{
			...
			if (empty($errors))
			{
				...
				trigger_error($this->language->lang('ACP_QNCK_SETTING_SAVED') . adm_back_link($this->u_action));
			}
		}
