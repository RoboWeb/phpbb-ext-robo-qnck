...
class main_module
{
	...
	public function main($id, $mode)
	{
		...
		/** @var \robo\qnck\controller\ucp_controller $ucp_controller */
		$ucp_controller = $phpbb_container->get('robo.qnck.controller.ucp');

		/** @var \phpbb\language\language $language */
		$language = $phpbb_container->get('language');

		// Load a template for our UCP page
		$this->tpl_name = 'ucp_qnck_body';

		// Set the page title for our UCP page
		$this->page_title = $language->lang('UCP_QNCK_TITLE');
